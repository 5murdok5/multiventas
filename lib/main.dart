...
import 'package:multiservicios_proveedor/src/logic/providers/provider_theme.dart';
import 'package:multiservicios_proveedor/src/routes/routes.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => ThemePrv()),
        ChangeNotifierProvider(create: (context) => PrvRegister()),
      ],
